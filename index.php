	...
	<div class="container">
		...
		<div class="row fixed-bottom justify-content-center">
			...
			<?php if(isset($_GET["edit"])): ?>
				<form action="php/todo.php" method="POST">
					...
					<div class="input-group input-group-lg">
						<input type="text" name="description" class="form-control" value="<?= $editTask['0']->description ?>" onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" autofocus/>
			...
			<form action="php/todo.php" method="POST">
				...
				<div class="input-group input-group-lg">
					<input type="text" name="description" class="form-control" placeholder="Task" autofocus/>
					<div class="input-group-append">
